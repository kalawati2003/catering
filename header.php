...
<body>
  ...
  <div class="container-fluid">
    <a class="navbar-brand" href="<?=ROOT;?>">Catering system</a>
    ...
    <div class="collapse navbar-collapse" id="navbarSupportedContent">
      <ul class="navbar-nav me-auto mb-2 mb-lg-0">
        ...
        <li class="nav-item">
          <a class="nav-link" id="hideaccess" href="<?=ROOT;?>menu/display">Menu</a>
        </li>
        <li class="nav-item dropdown">
          ...
          <ul class="dropdown-menu" aria-labelledby="navbarDropdown">
            ...
            <li><a class="dropdown-item" href="<?=ROOT;?>users/form">registration</a></li>
          </ul>
        </li>
        <?php if(Session::get('author')){?>
          <script>
